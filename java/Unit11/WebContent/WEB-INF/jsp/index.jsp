...
<div id="leftcol">
  ...
  <form name="formbday" method="get" action="index.html" id="formbday">
...
<div id="rightcol">
  ...
  <div id="searchdiv">
    <input type="text" name="q" id="q" size="55"/><button type="button" id="reset_button" onclick="document.getElementById('bday').value = ''; document.getElementById('q').value = ''; document.location.href='index.html'">x</button>&#160;
